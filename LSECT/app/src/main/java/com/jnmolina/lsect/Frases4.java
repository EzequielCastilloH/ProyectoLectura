...
public class Frases4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frases4);
        listPhrases = findViewById(R.id.listPhrases);
        btnBack = (ImageButton) findViewById(R.id.btnBackPhrases);

        db.collection("frases4").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    for (QueryDocumentSnapshot document : task.getResult()) {
                        ...
                        listArrayPhrases.add(new ObjectList(R.drawable.play, frase, url, "Tienda"));
                ...
                listPhrases.setAdapter(new AdaptadorLista(Frases4.this, R.layout.listview, listArrayPhrases) {
                    @Override
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                for (int i = 0; i < listArrayPhrases.size(); i++) {
                    if (position == listArrayPhrases.size() - 1) {
                        ...
                        Intent myIntent = new Intent(Frases4.this, testslsect_saludos.class);
                        startActivity(myIntent);
                    } else if (position == i) {
                        Intent myIntent = new Intent(Frases4.this, Animacion.class);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent btnBack = new Intent(Frases4.this, MenuPrincipal.class);
